    ...
    return (
        <section ref={ref} className="relative min-h-[60vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden py-12 md:py-0">
            ...
            <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
                ...
                <p className="animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200 fill-mode-backwards text-base md:text-2xl text-gray-400 font-medium max-w-xl md:max-w-2xl mx-auto mb-6 md:mb-10 leading-relaxed px-4">
                    <span className="flex items-center gap-2 text-sm md:text-base font-medium tracking-wide">
